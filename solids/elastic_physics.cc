...
{   // order: parameter a,b,u0,rho0,A,B,u_s,u_s_prime,alpha,beta,elastic shear modulus, hugoniot elastic limit [all cgs] //
    ...
    double qtmp[6][16]={
        {0.5,1.3,1.60e11,2.700,1.80e11,1.80e11,3.50e10,1.80e11,5.0,5.0,2.17e11,3.8e10, 4.0e29, 9.5, 1.0, 1.0},  // granite
        {0.5,1.5,4.87e12,2.700,2.67e11,2.67e11,4.72e10,1.82e11,5.0,5.0,2.27e11,3.5e10, 4.0e29, 9.5, 1.0, 1.0},  // basalt
        {0.5,1.5,9.50e10,7.860,1.28e12,1.05e12,1.42e10,8.45e10,5.0,5.0,7.75e11,8.5e10, 1.0e25, 9.0, 1.0, 1.0},  // iron
        {0.3,0.1,1.00e11,0.917,9.47e10,9.47e10,7.730e9,3.04e10,10.,5.0,2.80e10,1.0e10, 1.4e32, 9.1, 1.0, 1.0},  // ice
        {0.5,1.4,5.50e12,3.500,1.31e12,4.90e11,4.50e10,1.50e11,5.0,5.0,8.13e11,9.0e10, 4.0e29, 9.5, 1.0, 1.0},  // olivine/dunite
        {0.5,0.9,2.00e10,1.000,2.00e11,1.00e11,4.000e9,2.00e10,5.0,5.0,1.000e0,1.00e0, 0.0,    1.0, 0.0, 1.0}}; // water
    int j_t,k_t;
    for(j_t=1;j_t<7;j_t++)
    {
        for(k_t=0;k_t<16;k_t++)
        {
            ...
            // slots 12-15 (damage/porosity) intentionally not converted here; conversion (k_Weibull * UNIT_LENGTH_IN_CGS^3) is applied where consumed in Phase 17e C3/C5
        }
    }
    return;
}
