...
JEANS_REFINEMENT_IN_REGION_RADIUS_PC=400  # Radius around the flagged particle within which to apply the Jeans refinement criterion, in pc (physical units, not comoving). Only applies if JEANS_REFINEMENT_IN_REGION is enabled.
####################################################################################################-
