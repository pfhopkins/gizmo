...
void calculate_and_assign_conduction_and_viscosity_coefficients(int i, struct particle_data *pp, struct gas_cell_data *cell)
{
    ...
    /* v_magnitude seeded nonzero: an IC perfectly at rest leaves both sums exactly zero, and the
     * 0/0 below makes vel_scale_length NaN, which poisons the timestep. */
