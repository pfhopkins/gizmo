...
GIZMO_GPU_FUNCTION static inline double DMAX(double a, double b) { return (a > b) ? a : b; }
GIZMO_GPU_FUNCTION static inline double DMIN(double a, double b) { return (a < b) ? a : b; }
GIZMO_GPU_FUNCTION static inline int IMAX(int a, int b) { return (a > b) ? a : b; }
GIZMO_GPU_FUNCTION static inline int IMIN(int a, int b) { return (a < b) ? a : b; }
...
inline double evaluate_NH_from_GradRho(const Vec3<MyFloat>& gradrho, double rkern, double rho, double numngb_ndim, double include_h, int target, struct particle_data *pp = P) { return evaluate_NH_from_GradRho(const_cast<MyFloat*>(gradrho.data), rkern, rho, numngb_ndim, include_h, target, pp); }
