 ...
 * and differs between unequal members by sqrt(m1/m2). */
 ...
 * matters: GIZMO's documented recommendation (begrun.cc:2655), what production runs, and what 58
 * of 76 parameter files in the suite use. At its historical 0.5 the criterion is 142x worse than
 * the acceleration criterion in drift rate and 215x in |dE/E0|; 0.10 brings both inside parity
 * (0.0x / 0.6x). 0.15 does not (2.9x / 4.7x) and 0.25 is far outside (20.9x / 31.5x).
 *
