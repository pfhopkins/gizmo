...
#endif
#ifdef COSMIC_RAY_FLUID  /* CR flux only exists with the CR fluid; guard added 2026-07-04 (BOX_OUTFLOW_Z tallbox build w/o CRs — upstream left this unguarded, unlike the RT line above) */
