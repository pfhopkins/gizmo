 ...
 * macro-mangled. Same trap as cellcorrections_loop.cc / gradients_loop.cc.
 * All-mirror registration is auto-via the global constructor in
 * cooling/cooling.cc; no per-TU include needed. */
