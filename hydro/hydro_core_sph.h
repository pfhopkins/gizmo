...
#if defined(EOS_TILLOTSON) || defined(EOS_ELASTIC) || defined(EOS_ANEOS) /* need to include an effective stress for large negative pressures when elements are too close, to prevent tensile instability */
