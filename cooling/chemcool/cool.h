...
c
      ...
      integer ih3op
      parameter(ih3op = IH3OP+1)

      integer io2p
      parameter(io2p = IO2P+1)
...
#ifdef WSS_CIE_COOL
      REAL Zmass(12)
      REAL C_tbl(352), N_tbl(352), O_tbl(352)
      REAL Ne_tbl(352), Mg_tbl(352), Si_tbl(352)
      REAL S_tbl(352), Ca_tbl(352), Fe_tbl(352)
      REAL HeI_tbl(51), HeII_tbl(51)
#endif
c
...
c 
     ...
     $        no_chem,irad_heat,index_current, isrf_option
#ifdef TEST
      integer itest
#endif /* TEST */
...
c     Do not indent the next line!
     ...
     $,              itest
      ...
      REAL cool_h2_line, heat_accr
      REAL heat_cray, heat_photo_elec
      REAL cool_cplus, cool_oxy, cool_co, cool_gas_dust
      REAL cool_c, heat_h2_form, heat_h2_pdiss 
      common /thermal_info/ cool_h2_line, 
     $       heat_accr, cool_cplus, cool_oxy, cool_co,
     $       heat_cray, heat_photo_elec, cool_gas_dust,
     $       cool_c, heat_h2_form, heat_h2_pdiss
#endif
