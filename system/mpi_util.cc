                             ...
                             MPI_Status *status)
{
    ...
    if(dest != source) gizmo_emergency_hold_reviewed(3, "TEMP_HARD_CANDIDATE_INTERNAL: original endrun(3) -- mpi_util dest!=source invariant (mid-collective exchange; no symmetric poll)", __FILE__, __LINE__, __FUNCTION__);
