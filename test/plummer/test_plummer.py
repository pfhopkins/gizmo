...
# starforge_dev variant sits at 1.7e-2, so a regression has to nearly triple the worst
...
#
# Rates below are starforge_dev's, fitted over its full TimeMax=48 trajectory, times 3x.
