"""Toth MHD shock tube test (Hopkins & Raives 2016)

MHD shock tube problem from Toth (2000). Since there is no provided exact
solution file, this test verifies that the simulation runs to completion and
produces physically reasonable output.
"""
