...
def test_wind_thermo_fidelity():
    ...
    T/u at the frozen fully-ionized slope. These checks
    are calibrated on runs with a correct temperature inversion, two of which agree
    to <~1% while a build with the defective inversion fails both.
