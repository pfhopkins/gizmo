...
The headline harness comparison (free-slot preserves the +2 perturbation
and the dominant +1 stream better than W2/v_only) is reported via the
per-stream band masses + plot, not asserted as a hard gate here.
