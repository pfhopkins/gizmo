...
#
# Ceilings are 3x the |dE/E0| measured at the END of a TimeMax=118 reference run,
...
def test_hernquist(num_mpi_ranks, num_omp_threads, extra_config_flags, request):
    ...
    calibrated = "recorded reference run @ t=118" if variant_id in ENERGY_TOL else "default (uncalibrated)"
