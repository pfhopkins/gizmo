...
CORE_OBJS =	core/main.o core/accel.o core/timestep.o core/init.o file_io/restart.o file_io/io.o \
			...
			mesh/ghost_exchange.o mesh/ghost_writeback.o mesh/neighbor_list.o mesh/sfc_tiles.o mesh/gpu_dirty_tracker.o mesh/mode_b_local_walker.o mesh/state_hash.o compile_time_info.o mesh/merge_split.o \
