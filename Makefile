...
GPU_OBJS = cooling/cooling.o eos/eos.o hydro/density_gpu.o mesh/gpu_neighbor_list.o radiation/rt_chem.o turb/turb_driving.o turb/difffilter_gpu.o solids/grain_drag_gpu.o galaxy_sf/dm_dispersion_gpu.o gravity/ags_density_gpu.o gravity/ags_force_gpu.o sidm/dm_fuzzy_gpu.o sinks/sink_environment_gpu.o sidm/cbe_integrator_gpu.o radiation/rt_source_injection_gpu.o galaxy_sf/thermal_fb_gpu.o sinks/sink_feed_gpu.o galaxy_sf/mechanical_fb_gpu.o solids/grain_physics_gpu.o sinks/sink_swallow_and_kick_gpu.o galaxy_sf/radfb_local_gpu.o system/gpu_particles_arena.o gravity/gpu_gravity_tree.o gravity/gpu_gravtree.o gravity/gpu_moment_refresh.o gravity/gpu_nextnode_thread.o gravity/gpu_morton.o gravity/gpu_peano_walk.o gravity/gpu_topology_build.o gravity/gpu_topology_finalize.o gravity/gpu_pseudo_update.o
